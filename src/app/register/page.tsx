...
const Register = () => {
    ...
    return (
        <div className="h-screen flex justify-center items-center bg-bg-color">
            <div className="w-1/2 rounded-md bg-custom-register flex justify-between flex-col">
                <div className="h-28 w-full justify-center flex items-center">
                    <span className="text-3xl text-white font-mono font-semibold p-3 rounded-lg">Welcome</span>
                </div>
                ...
                <div className="h-20 mx-auto">
                    <span className="text-sm text-white-600">Already have account?  
